...
function submitForm(inptData, getForm){
    ...
    if(getForm === "syllabus"){
        ...
        $.ajax({
            ...
            url: "workplace/add-syllabus-leads.php",

            data: "formtype=syllabus"+ "&firstname=" + fName + "&lastname=" + lName + "&email=" + email + "&mobile=" + mobileNo + "&city=" + city + "&lookingfor=" + lookingFor + "&message=" + message,
    ...
    if(getForm === "enquiry"){
        ...
        $.ajax({
            ...
            data: "formtype=enquiry"+ "&name=" + name + "&email=" + email + "&mobile=" + mobileNo + "&lookingfor=" + lookingFor + "&message=" + message,
    ...
    if(getForm === "enquire-consulation"){
        ...
        $.ajax({
            ...
            data: "formtype=consulation"+ "&name=" + name + "&email=" + email + "&mobile=" + mobileNo + "&city="+city,
...
function validateForm(req){
    ...
    function emailValidate(){
        var nodes = document.querySelectorAll(".request-form input[type=email]");
